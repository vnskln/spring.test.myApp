                ...
                <div class="container">
                    <div class="row ">
                        <div class="col pt-5">
                            ...
                            <p class="text-center">current number of employees: ${numberOfEmployees}</p>
                            <p class="text-center">data generated by <a href="https://www.generatedata.com/">https://www.generatedata.com</a></p>
                        </div>
                    </div>
                </div>
            </section>
